const IconEmailArrow = () => {
  return (
    ...
    >
      <circle cx="35" cy="35" r="35" fill="url(#paint0_linear_303_319)" />
      <path
      ...
      />
      <path
        d="M25.2636 40.9555L27.9971 50.6841C28.3427 51.9157 29.3387 52.8313 30.5949 53.0729C31.8777 53.3192 33.1321 52.8124 33.894 51.8182L52.3678 27.7111C53.2092 26.6137 53.3019 25.1879 52.6106 23.9905L24.979 39.9436L25.2636 40.9555Z"
        fill="white"
      />
      <path
